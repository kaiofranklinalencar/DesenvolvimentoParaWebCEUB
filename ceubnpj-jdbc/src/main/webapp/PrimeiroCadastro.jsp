...
<body>
    <script src="https://kit.fontawesome.com/a86ab39c2a.js" crossorigin="anonymous"></script>
        ...
        <section class="main">
                ...
                <div class="nome" action="AdicionaContato" method="POST"> <!-- tem que colocar o action aqui para salvar o dado no
                banco da dados, depois que fizer a conexão, utilizar o get conection-->
                    <label> Nome: </label>  
